...
class EcsClient(object):
    ...
    def update_service(
        self, cluster_name: str, app_name: str, task_definition, force_deployment=False
    ):
    ...
    def get_deployment_id(self, cluster_name: str, service_name: str):
        result = self.boto.describe_services(cluster=cluster_name, services=[service_name])
    ...
    def get_taskset_id(self, cluster_name: str, service_name: str):
        result = self.boto.describe_services(cluster=cluster_name, services=[service_name])
    ...
    def get_service(self, cluster_name: str, service_name: str):
        return self.boto.describe_services(cluster=cluster_name, services=[service_name])

    # TO-DO: This function should be 3 different functions: setTaskSetId, setEcsDeployId and describeService
    def describe_service(self, cluster_name, app_name):
    ...
    # TO-DO: Functions should be pure (this one is returning and setting at the same time)
    ...
    def run_task(
        self, cluster_name: str, task_definition, launchtype: str, subnets, security_groups
    ):
